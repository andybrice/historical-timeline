...
width = @year_range.size + 100

xml.svg :xmlns => 'http://www.w3.org/2000/svg', :version => 1.1, :width => width, :height => 3000, 'transform-origin' => '100, 200' do
  xml.title 'Historical Timeline Generator by Andy Brice'

  x_offset = (@timeline_start * -1) + 50.5

  xml.g :transform => "translate(#{x_offset}, 50.5)" do # set origin
